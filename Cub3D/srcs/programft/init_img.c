...
/*   Updated: 2023/05/30 16:43:06 by sgerace          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	while (i < 4)
	{
		if (i == 0)
			cub->graphic_info.texture[i] = make_img(cub->mlx, \
				"/Users/sgerace/Desktop/Cub3D-in-Love/Cub3D/img/EA.xpm");
		else if (i == 1)
			cub->graphic_info.texture[i] = make_img(cub->mlx, \
				"/Users/sgerace/Desktop/Cub3D-in-Love/Cub3D/img/NO.xpm");
		else if (i == 2)
			cub->graphic_info.texture[i] = make_img(cub->mlx, \
				"/Users/sgerace/Desktop/Cub3D-in-Love/Cub3D/img/SO.xpm");
		else if (i == 3)
			cub->graphic_info.texture[i] = make_img(cub->mlx, \
				"/Users/sgerace/Desktop/Cub3D-in-Love/Cub3D/img/WE.xpm");
		img_info.buf = \
